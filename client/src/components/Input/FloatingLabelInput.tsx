            ...
            <div className="relative">
                <input
                    ...
                    className={`${newInputClassName
                        ? newInputClassName
                        : `block px-2.5 pb-2.5 pt-4 w-full text-sm text-heading bg-transparent rounded-lg
                            border border-default-medium appearance-none focus:outline-none 
                            focus:ring-0 focus:border-brand peer 
                            ${inputClassName}`
                        }`}
                    placeholder=" "
                    autoFocus={autoFocus}
                ...
                <label
                    ...
                    className={`${newLabelClassName
                        ? newLabelClassName
                        : `absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-left 
                            ...
                            peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto inset-s-1 
                            ${labelClassName}`
                        }`}
                >
                    {label}
