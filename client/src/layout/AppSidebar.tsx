    ...
    return (
        <>
            ...
            <aside
                ...
                aria-label="Sidebar"
            >
                <div className="h-full px-3 py-20 overflow-y-auto bg-blue-950 border-e border-default">

                    <ul className="space-y-2 font-medium">
                        <li>
                            <a href="#" className="flex items-center px-2 py-1.5 text-body rounded-lg hover:bg-linear-to-r from-blue-100 to-blue-900 text-blue-200 hover:text-black hover:text-fg-brand group">
                        ...
                        <li>
                            <a href="#" className="flex items-center px-2 py-1.5 text-body rounded-lg hover:bg-blue-500/50 hover:text-fg-brand group">
