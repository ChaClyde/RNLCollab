                ...
                action: (
                    <>
                        <div className="flex gap-4">
                            <div>
                                <Link to="/departments/edit" className="text-green-800 hover:underline font-medium" >
                                    Edit
                                </Link>
                            </div>
                            <div>
                                <Link to="/departments/delete" className="text-red-800 hover:underline font-medium" >
                                    Delete
                                </Link>
                            </div>
                        </div>
